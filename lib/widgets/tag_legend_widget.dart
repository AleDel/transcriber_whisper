...
class _TagLegendWidgetState extends State<TagLegendWidget> {
  ...
  void _updateSegmentData() {
    ...
    final segmentData = _getSegmentData(transcription.rawRealTextSegments ?? []);
              ...
              children: [
                Wrap(
                  ...
                  children: sortedTags.map((entry) {
                    ...
                    final List<String> taggedWords = _findTaggedWords(transcription.rawRealTextSegments ?? [], tag);
